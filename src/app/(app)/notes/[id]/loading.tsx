...
export default function Loading() {
  return (
    <div className="flex h-[calc(100dvh-9rem)] flex-col md:h-[calc(100dvh-7.5rem)]">
      <div className="flex min-h-0 flex-1 animate-pulse flex-col rounded-card bg-surface p-6 md:px-10 md:py-8">
        <div className="mb-5 flex items-center justify-between gap-2">
          <div className="h-[32px] w-32 rounded-utility bg-veil/5" />
          <div className="h-4 w-16 rounded bg-veil/5" />
        </div>
        <div className="mb-4 h-9 w-2/3 rounded-utility bg-veil/10" />
